...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/inc/plugins/contact-form-7.3.7.zip', // The plugin source
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/inc/plugins/woocommerce.2.1.1.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/inc/plugins/wp-retina-2x.1.9.2.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
...
function theretailer_styles() {	
	...
	wp_register_style('stylesheet', get_stylesheet_uri(), array(), '1.8.6', 'all');
...
function theretailer_scripts() {  
	...
	//wp_register_script('favico', get_template_directory_uri() . '/js/favico-0.3.4.min.js', 'jquery', '0.3.4', TRUE);
	...
	//}
	wp_register_script('init', get_template_directory_uri() . '/js/init.js', 'jquery', '1.8.6', TRUE);
