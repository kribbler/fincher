...
class Fincher_WC_Widget_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'Fincher WooCommerce Product Categories', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
	...
	public function widget( $args, $instance ) {
		extract( $args );
		//echo 'i am the fincher category widget!';
		...
		// List
			...
			echo (wp_list_categories( apply_filters( 'woocommerce_product_categories_widget_args', $list_args ) ));
